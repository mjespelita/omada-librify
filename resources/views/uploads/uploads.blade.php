...
@section('content')
    <div class='row'>
        <div class='col-lg-6 col-md-6 col-sm-12'>
            <h1>All Data Uploads</h1>
        </div>
        <div class='col-lg-6 col-md-6 col-sm-12' style='text-align: right;'>
            <a href='{{ url('trash-uploads') }}'><button class='btn btn-danger'><i class='fas fa-trash'></i> Trash <span class='text-warning'>{{ App\Models\Uploads::where('isTrash', '1')->count() }}</span></button></a>
            <a href='{{ route('uploads.create') }}'><button class='btn btn-success'><i class='fas fa-plus'></i> Add Uploads</button></a>
        </div>
    </div>
            ...
            <div class='row'>
                <div class='col-lg-4 col-md-4 col-sm-12 mt-2'>
                    <div class='row'>
                        ...
                        <div class='col-8'>
                            <form action='{{ url('/uploads-paginate') }}' method='get'>
                ...
                <div class='col-lg-4 col-md-4 col-sm-12 mt-2'>
                    <form action='{{ url('/uploads-filter') }}' method='get'>
                        <div class='input-group'>
                ...
                <div class='col-lg-4 col-md-4 col-sm-12 mt-2'>
                    <!-- Search Form -->
                    <form action='{{ url('/uploads-search') }}' method='GET'>
                        <div class='input-group'>
                    ...
                    <tbody>
                        @forelse($uploads as $item)
                            <tr>
                                ...
                                <td>
                                    <a href='{{ route('uploads.show', $item->id) }}'><i class='fas fa-eye text-success'></i></a>
                                    <a href='{{ route('uploads.edit', $item->id) }}'><i class='fas fa-edit text-info'></i></a>
                                    <a href='{{ route('uploads.delete', $item->id) }}'><i class='fas fa-trash text-danger'></i></a>
                                </td>
                            </tr>
                        @empty
                            <tr>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.bulk-delete').click(function () {
                ...
                $.post('/uploads-delete-all-bulk-data', {
                    ids: array,
            ...
            $('.bulk-move-to-trash').click(function () {
                ...
                $.post('/uploads-move-to-trash-all-bulk-data', {
                    ids: array,
                    _token: $("meta[name='csrf-token']").attr('content')
                }, function (res) {
                    window.location.reload();
